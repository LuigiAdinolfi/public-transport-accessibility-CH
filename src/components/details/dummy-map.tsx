...
export function DummyMap(): React.ReactElement {
  return (
    <Card className="p-6">
      ...
      <div
        className="flex h-96 items-center justify-between rounded-lg border border-zinc-200 bg-white text-zinc-950 shadow-sm dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-50"
        aria-hidden="true"
      >
        <Image
          src="/map.png"
